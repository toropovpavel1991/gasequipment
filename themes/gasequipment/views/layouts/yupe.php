...
<head>
    <?php
    \yupe\components\TemplateEvent::fire(GasequipmentThemeEvents::HEAD_START);
    ...
    <?php \yupe\components\TemplateEvent::fire(GasequipmentThemeEvents::HEAD_END);?>
</head>

<body>
<?php \yupe\components\TemplateEvent::fire(GasequipmentThemeEvents::BODY_START);?>
<div class="main">
...
<?php \yupe\components\TemplateEvent::fire(GasequipmentThemeEvents::BODY_END);?>
